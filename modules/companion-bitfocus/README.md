# presentatool — Bitfocus Companion module

Drives [Presentatool](../../) from [Bitfocus Companion](https://bitfocus.io/companion) so you can
...
2. Restart Companion.
3. Add a new connection of type **Presentatool**.
4. Fill in:
   - Host (e.g. `127.0.0.1`)
   - Port (`4711` default)
   - API token (from Presentatool's Settings → *Bitfocus Companion / API token*)

See [companion/HELP.md](companion/HELP.md) for the full list of actions, variables and feedbacks.

## How it works

The module opens a WebSocket to the Presentatool desktop on `/ws` and sends a `hello` message
